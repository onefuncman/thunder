...
// KamiClient: yoinked from Hurricane's haven.automated.CombatDistanceTool.
// Tweaks for KamiClient: Gob.vehicleId() instead of Gob.occupiedGobID,
// GameUI.MsgType.INFO instead of Color overload, no pfthread to interrupt.
public class CombatDistanceTool extends Window implements Runnable {
    public static final Map<String, Double> animalDistances;
    public static final Map<String, Double> vehicleDistance;
    static {
	Map<String, Double> a = new HashMap<>();
	a.put("gfx/kritter/adder/adder", 17.1);
	a.put("gfx/kritter/ant/ant", 15.2);
	a.put("gfx/kritter/cattle/cattle", 27.0);
	a.put("gfx/kritter/badger/badger", 19.9);
	a.put("gfx/kritter/bear/bear", 24.7);
	a.put("gfx/kritter/bear/polarbear", 24.7);
	a.put("gfx/kritter/boar/boar", 25.1);
	a.put("gfx/kritter/caveangler/caveangler", 27.2);
	a.put("gfx/kritter/cavelouse/cavelouse", 22.0);
	a.put("gfx/kritter/fox/fox", 18.1);
	a.put("gfx/kritter/horse/horse", 23.0);
	a.put("gfx/kritter/lynx/lynx", 20.0);
	a.put("gfx/kritter/mammoth/mammoth", 30.3);
	a.put("gfx/kritter/moose/moose", 25.0);
	a.put("gfx/kritter/narwhal/narwhal", 32.0);
	a.put("gfx/kritter/orca/orca", 49.25);
	a.put("gfx/kritter/reddeer/reddeer", 25.0);
	a.put("gfx/kritter/roedeer/roedeer", 22.0);
	a.put("gfx/kritter/spermwhale/spermwhale", 112.2);
	a.put("gfx/kritter/goat/wildgoat", 18.9);
	a.put("gfx/kritter/wolf/wolf", 25.0);
	a.put("gfx/kritter/wolverine/wolverine", 21.0);
	a.put("gfx/borka/body", 55.0);
	animalDistances = Collections.unmodifiableMap(a);

	Map<String, Double> v = new HashMap<>();
	v.put("gfx/terobjs/vehicle/rowboat", 13.3);
	v.put("gfx/terobjs/vehicle/dugout", 7.4);
	v.put("gfx/terobjs/vehicle/snekkja", 29.35);
	v.put("gfx/terobjs/vehicle/knarr", 54.5);
	v.put("gfx/kritter/horse/stallion", 5.4);
	v.put("gfx/kritter/horse/mare", 5.4);
	vehicleDistance = Collections.unmodifiableMap(v);
    }
    ...
    private void tryToAutoDistance() {
        if (gui != null && gui.map != null && gui.map.player() != null && gui.fv.current != null) {
            ...
            if (vid != 0) {
                Gob vehicle = ui.sess.glob.oc.getgob(vid);
