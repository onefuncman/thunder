...
public enum Action {
    ...
    OPEN_COOKBOOK(GameUI::toggleCookbook, "Open cookbook", "Browse the automap site's food FEP database in-game (uses the Mapping URL from Options). Type to filter (name:/from:/attr comparisons)."),
