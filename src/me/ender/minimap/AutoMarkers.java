...
public class AutoMarkers {
	...
	final VO markers = gson.fromJson(Config.loadJarFile("automark.json5"), VO.class);
	for (final String marker : markers.basic.keySet()) {
	    automark.put(marker, markers.basic.get(marker));
	}
    }
